...
import {
    ...
    validateAdminToken as api_auth_admin_validateAdminToken
} from "~backend/auth/admin";
import {
    customerLogin as api_auth_customer_customerLogin,
    customerRegister as api_auth_customer_customerRegister
} from "~backend/auth/customer";
...
export namespace auth {
    ...
    export class ServiceClient {
         ...
         */
        public async customerLogin(params: RequestType<typeof api_auth_customer_customerLogin>): Promise<ResponseType<typeof api_auth_customer_customerLogin>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/customer/login`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_customer_customerLogin>
        }

        /**
         * Customer registration endpoint
         */
        public async customerRegister(params: RequestType<typeof api_auth_customer_customerRegister>): Promise<ResponseType<typeof api_auth_customer_customerRegister>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/customer/register`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_customer_customerRegister>
        }

        /**
         * Validate admin token
         */
        public async validateAdminToken(params: RequestType<typeof api_auth_admin_validateAdminToken>): Promise<ResponseType<typeof api_auth_admin_validateAdminToken>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/validate`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_auth_admin_validateAdminToken>
        }
    }
}
...
import { deleteOrder as api_orders_delete_deleteOrder } from "~backend/orders/delete";
...
export namespace orders {
    ...
    export class ServiceClient {
        ...
        public async deleteOrder(params: { id: number }): Promise<void> {
            await this.baseClient.callTypedAPI(`/orders/${encodeURIComponent(params.id)}`, {method: "DELETE", body: undefined})
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { getMysteryBox as api_products_get_getMysteryBox } from "~backend/products/get";
...
export namespace products {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.getMysteryBox = this.getMysteryBox.bind(this)
        }

        /**
         * Get the mystery box product
         */
        public async getMysteryBox(): Promise<ResponseType<typeof api_products_get_getMysteryBox>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/products/mystery-box`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_products_get_getMysteryBox>
        }
    }
}
...
import { updateSettings as api_settings_update_updateSettings } from "~backend/settings/update";
...
export namespace settings {
    ...
    export class ServiceClient {
         ...
         */
        public async updateSettings(params: RequestType<typeof api_settings_update_updateSettings>): Promise<ResponseType<typeof api_settings_update_updateSettings>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/settings`, {method: "PUT", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_settings_update_updateSettings>
        }
    }
}
