...
```bash
git remote add encore encore://boxu-mystery-box-store-qpo2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/boxu-mystery-box-store-qpo2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/boxu-mystery-box-store-qpo2/settings/integrations/github)
